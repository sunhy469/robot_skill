...
def db_new_area(token: str, name_list: str, eoat: str, pose: str, rotation: str, offset_z: str, type: str, area_type: str, tag_area: str, upland_z: str, teach_plate_inside_z: str) -> Dict[str, Any]: return request_json("POST", "/database/newArea/", with_token(token, {"nameList": name_list, "eoat": eoat, "pose": pose, "rotation": rotation, "offsetZ": offset_z, "type": type, "AreaType": area_type, "TagArea": tag_area, "uplandZ": upland_z, "teachPlateInsideZ": teach_plate_inside_z}))
